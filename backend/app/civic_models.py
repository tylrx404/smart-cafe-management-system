...
Importing this module registers CivicReport and CivicNotification
onto the shared Base so create_all() picks them up.
"""
...
class CivicReport(Base):
    ...
    department      = Column(String, nullable=False)          # handling department
